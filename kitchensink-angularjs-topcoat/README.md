kitchensink-angularjs-topcoat: Use AngularJS and Topcoat with JAX-RS and Java EE in JBoss EAP
========================
Author: Pete Muir  
Level: Intermediate  
Technologies: AngularJS, Topcoat, CDI, JPA, EJB, JPA, JAX-RS, BV  
Summary: Demonstrates how to use AngularJS and Topcoat with JAX-RS and Java EE in JBoss EAP.  
...
The `kitchensink-angularjs-topcoat` quickstart is based on the `kitchensink` quickstart, but demonstrates the use of AngularJS and Topcoat in Red Hat JBoss Enterprise Application Platform. This project is setup to allow you to create a compliant Java EE 6 application using CDI 1.0, EJB 3.1, JPA 2.0 and Bean Validation 1.0. It includes a persistence unit and some sample persistence and transaction code to introduce you to database access in enterprise Java.
...
The application this project produces is designed to be run on Red Hat JBoss Enterprise Application Platform 6. 
